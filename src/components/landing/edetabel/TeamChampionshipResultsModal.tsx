// src/components/edetabel/TeamChampionshipResultsModal.tsx
"use client";

import { useState, useEffect } from "react";
import { supabase } from "@/lib/supabase";

interface TeamChampionshipResultsModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function TeamChampionshipResultsModal({
  isOpen,
  onClose,
  championshipId,
  championshipName,
}: TeamChampionshipResultsModalProps) {
              ...
              <table className="w-full">
                ...
                <tbody>
                  {sortedResults.map((team, index) => {
                    ...
                    return (
                      <tr
                        key={`${team.team_id}-${team.class_name}`}
