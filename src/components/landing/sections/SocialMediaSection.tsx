    ...
    <div className="text-center mt-16">
      ...
      <div className="flex justify-center items-center space-x-6">
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="group w-16 h-16 bg-gradient-to-br from-slate-600/20 to-slate-900/20 backdrop-blur-xl border border-slate-500/30 hover:border-slate-400/50 rounded-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-slate-500/25"
        >
          <svg className="w-8 h-8 text-slate-400 group-hover:text-slate-300 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
