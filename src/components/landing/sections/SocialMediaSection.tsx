...
export function SocialMediaSection() {
  return (
    <div className="text-center mt-16 sm:mt-32 mb-0 pt-8 sm:pt-16 relative px-4 sm:px-0">
      ...
      <h4 className="text-xl sm:text-2xl font-black text-white mb-8 sm:mb-12 font-['Orbitron'] uppercase tracking-wider">
        Jälgi meid sotsiaalmeedias
      </h4>
      

      {/* Social Media Icons Container - Now responsive */}
      <div className="flex justify-center items-center flex-wrap gap-4 sm:gap-6 md:gap-8 max-w-md mx-auto sm:max-w-none">
        ...
        >
          <div className="relative w-14 h-14 sm:w-16 sm:h-16">
            ...
            <div className="absolute inset-0 bg-red-500 blur-xl sm:blur-2xl opacity-0 group-hover:opacity-30 transition-opacity"></div>
            
            {/* Button */}
            <div className="relative w-full h-full bg-gradient-to-br from-gray-900 to-black border border-gray-700/50 group-hover:border-red-500/50 rounded-xl sm:rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-gray-500 group-hover:text-red-500 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
