// src/components/landing/sections/FeaturesSection.tsx - UPDATED with Edetabel
'use client'
...
export function FeaturesSection({ onOpenCompetitions, onOpenEdetabel }: FeaturesSectionProps) {
  return (
