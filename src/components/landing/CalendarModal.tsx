// src/components/landing/CalendarModal.tsx - Public Calendar View
'use client'
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div 
          className="relative w-full max-w-4xl bg-gray-900 rounded-2xl border border-red-500/30 shadow-2xl transform transition-all"
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                className="px-4 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-red-500/50 rounded-lg transition-all duration-300"
              >
