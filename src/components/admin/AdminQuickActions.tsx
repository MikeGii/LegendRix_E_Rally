// src/components/admin/AdminQuickActions.tsx - Updated with Sponsors route
export function AdminQuickActions() {
  ...
  const handleSponsorsManagement = () => {
  ...
  return (
    <div className="bg-slate-800/30 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6">
      ...
      <div className="flex flex-wrap gap-4 justify-center md:justify-start">
        ...
        <button 
          onClick={handleSponsorsManagement}
          className="flex items-center space-x-3 px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-orange-500/25"
        >
          <span className="text-xl">💝</span>
          <span>Toetamised</span>
        </button>
      </div>
    </div>
  )
