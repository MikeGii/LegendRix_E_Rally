// src/components/RallyRegistration.tsx - FUTURISTIC MODULAR REDESIGN
'use client'
...
export function RallyRegistration({ preselectedRallyId }: RallyRegistrationProps) {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="fixed top-40 right-40 w-96 h-96 bg-red-600/10 rounded-full blur-3xl pointer-events-none"></div>
      <div className="fixed bottom-40 left-40 w-96 h-96 bg-gray-600/10 rounded-full blur-3xl pointer-events-none"></div>
      
      <div className="relative z-10 max-w-7xl mx-auto p-6 pt-10">
        {/* Unified Header */}
        ...
        {selectedRally ? (
          canRegisterToRally(selectedRally) ? (
            ...
            <div className="grid lg:grid-cols-5 gap-6">
              {/* Rally Details - 60% width (3 of 5 columns) */}
              <div className="lg:col-span-3">
                <RallyDetails rally={selectedRally} />
              </div>

              {/* Registration Form - 40% width (2 of 5 columns) */}
              <div className="lg:col-span-2">
                <div className="tech-border rounded-2xl bg-black/90 backdrop-blur-xl p-6">
                  {/* Form Header */}
                  <div className="flex items-center space-x-3 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-red-900/30 to-red-800/20 rounded-xl flex items-center justify-center border border-red-500/30 shadow-[0_0_15px_rgba(255,0,64,0.3)]">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">Vali klass ja registreeru</p>
                    </div>
                  </div>
