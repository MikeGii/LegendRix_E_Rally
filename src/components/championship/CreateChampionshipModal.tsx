...
import { useCreateChampionship, useAddRallyToChampionship, Championship } from '@/hooks/useChampionshipManagement'
...
export function CreateChampionshipModal({ championship, onClose, onSuccess }: CreateChampionshipModalProps) {
  ...
  // Note: ApprovedRally doesn't have game_id, so we filter by game_name instead
  ...
  const handleSave = async () => {
    try {
      ...
      const newChampionship = await createChampionshipMutation.mutateAsync(formData)
  ...
  const isLoading = createChampionshipMutation.isPending || addRallyMutation.isPending
      ...
      <div className="bg-slate-800 rounded-2xl border border-slate-700/50 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-slate-800 border-b border-slate-700/50 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-white">
                {championship ? 'Muuda meistrivõistlust' : 'Loo uus meistrivõistlus'}
              </h2>
              <p className="text-slate-400 mt-1">
                {currentStep === 1 ? 'Sisesta meistrivõistluse andmed' : 'Vali rallid ja määra järjekord'}
              </p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="flex items-center space-x-4 mt-6">
            ...
            <div className={`w-8 h-0.5 ${currentStep === 2 ? 'bg-blue-500' : 'bg-slate-600'}`}></div>
            <div className={`flex items-center space-x-2 px-3 py-1 rounded-full text-sm font-medium ${
              currentStep === 2 
                ? 'bg-blue-500/20 text-blue-400 border border-blue-500/30' 
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="nt. Eesti Ralliautode Meistrivõistlused 2025"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('season_year', parseInt(e.target.value) || new Date().getFullYear())}
                min="2020"
                max="2030"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleInputChange('game_type_id', e.target.value)}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-blue-400 font-medium">Rallide valimine</h4>
                  <p className="text-blue-300/80 text-sm mt-1">
                    Vali kinnitatud tulemustega rallid, mida soovid meistrivõistlustesse kaasata. 
                    Rallid lisatakse valitud järjekorras (1. ring, 2. ring jne).
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-yellow-400 text-sm">
                    Näidatakse ainult "{games.find(g => g.id === formData.game_id)?.name}" mängu rallisid
                  </span>
                </div>
              </div>
            )}
            ...
            <div>
              ...
              {filteredRallies.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-slate-300 mb-2">Rallisid ei leitud</h3>
