...
export function UpcomingRalliesSection({ rallies, isLoading, canAccessRallies }: UpcomingRalliesSectionProps) {
  ...
  return (
    ...
    <div className="upcoming-rallies-container">
      ...
      {/* Content Section */}
      <div className="relative bg-gradient-to-br from-gray-900/95 to-black/95 rounded-2xl overflow-hidden border border-gray-800 shadow-[0_0_50px_rgba(0,0,0,0.7)]">
